...
밝은 표면에서 키보드 포커스 표시가 보이지 않던 문제를 해소했다. 발단은 [brand-pivot-bronze](../../../.bkit-memory.json) (PR #20) 에서 후속 ①로 남긴 건이었으나, 착수 후 **포커스 시스템이 하나가 아니라 둘이고 두 번째는 대비 미달이 아니라 표시 부재**임이 드러나 심각도가 올라갔다.
