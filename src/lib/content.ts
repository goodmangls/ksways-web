...
export const homeContent: Record<Locale, HomeCopy> = {
  en: {
    ...
    hero: {
      ...
      lead: 'KS WAYS is a global logistics company responsible for ocean and air freight, with particular strength in sea freight and trusted partner-network execution for exporters, buyers, and growing brands.',
    ...
    operating: {
      ...
      body: 'KS WAYS supports ocean freight, air freight, and cross-border cargo flows with a clean operating rhythm: understand the shipment, select the route, coordinate the handoff, and keep partners informed.',
      services: [
    ...
    network: {
      ...
      body: 'As a WCA member, KS WAYS works through global agent cooperation with practical routing, responsive communication, and responsible handoffs — so each partner knows who owns the next step.',
    ...
    solutions: {
      ...
      body: 'From the first request to final delivery, KS WAYS keeps the process focused on the facts that matter: cargo readiness, route feasibility, cost, risk, and timing.',
      steps: [
  ...
  kr: {
    ...
    hero: {
      ...
      lead: 'KS WAYS는 해상물류와 항공물류를 책임지는 글로벌 물류회사로, 특히 해운에 강점을 두고 WCA 글로벌 네트워크 기반의 파트너 실행력을 제공합니다.',
      primaryCta: '견적 문의',
    ...
    operating: {
      ...
      body: 'KS WAYS는 해상 운송, 항공 운송, 크로스보더 화물 흐름을 지원하며, 화물 이해·라우트 선정·핸드오프 조율·파트너 커뮤니케이션을 일관된 리듬으로 관리합니다.',
      services: [
        { title: '항공 운송', body: '긴급·고가·시간 민감 화물을 위한 빠른 운송 기획.', href: '/services/air-freight-korea' },
        { title: '해상 운송', body: 'KS WAYS의 핵심 강점인 FCL/LCL 기반 운송사 및 파트너 조율.', href: '/services/ocean-freight-korea' },
    ...
    network: {
      ...
      body: 'KS WAYS는 WCA 회원사로서 실질적인 라우팅, 빠른 커뮤니케이션, 책임 있는 핸드오프를 중심으로 글로벌 에이전트 협력을 운영합니다.',
      points: ['WCA 회원 네트워크', '해상·항공 운송 협력', '운영 책임성과 투명한 커뮤니케이션', '글로벌 파트너 커버리지'],
    },
    solutions: {
      kicker: '업무 방식',
      headline: '모든 문의에 더 명확한 다음 경로를 제시합니다.',
      body: '첫 문의부터 최종 배송까지, KS WAYS는 화물 준비 상태, 라우트 가능성, 비용, 리스크, 일정이라는 핵심 사실에 집중합니다.',
      steps: [
